...
export const metadata: Metadata = {
  title: 'Yasal Uyarı ve Kullanım Koşulları — Zirve Namus',
  description: 'Zirve Namus platformuna ait yasal uyarı, kullanım koşulları ve gizlilik politikası.',
};
      ...
      <div className="max-w-3xl mx-auto px-4 py-8 space-y-6">
        ...
        <div className="border-t border-zinc-800 pt-4 flex items-center justify-between">
          <p className="text-zinc-700 text-xs">
            Son güncelleme: {UPDATE_DATE} · © {new Date().getFullYear()} ZİRVE NAMUS
          </p>
          <Link
            href="/"
